...
BUI_GAMEPAD_DEFAULT_PANEL_WIDTH = 670
...
BUI_GAMEPAD_LIST_SCREEN_X_OFFSET = 80 -- x offset to the left limit of the entry text.
...
BUI_GAMEPAD_DEFAULT_PANEL_CONTAINER_WIDTH = 670
-- Quadrant 1
