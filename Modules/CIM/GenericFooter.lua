...
function BUI.GenericFooter:Refresh()
	...
	if(self.footer.GoldLabel ~= nil) then
		self.footer.GoldLabel:SetText(zo_strformat("|cFFBF00<<1>>|r |t16:16:/esoui/art/currency/currency_gold.dds|t",BUI.DisplayNumber(GetCarriedCurrencyAmount(CURT_MONEY))))
		...
		self.footer:GetNamedChild("GoldLabel"):SetText(zo_strformat("|cFFBF00<<1>>|r |t16:16:/esoui/art/currency/currency_gold.dds|t",BUI.DisplayNumber(GetCarriedCurrencyAmount(CURT_MONEY))))
